    ...
    with open(filename, "r") as vcf_file:
        for line in vcf_file:
            if line[0] != "#":
                ...
                gt_vals_giraffe = tokens[10].split(":")
                gt_vals_bwa = tokens[9].split(":")
        ...
        with open ("indel_fractions.json", "w") as out_file:
            json.dump([all_fractions_giraffe, all_fractions_bwa], out_file)
        
        return (all_fractions_giraffe, all_fractions_bwa)
...
def main():
    ...
    (all_fractions_giraffe, all_fractions_bwa) = get_fractions(args.vcf_file)
    ...
    all_fractions_giraffe = all_fractions[1]
    all_fractions_bwa = all_fractions[0]
